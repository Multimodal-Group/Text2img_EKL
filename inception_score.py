...
tf.app.flags.DEFINE_string('checkpoint_dir',
                           '../data/StackGAN-inception-model-master/inception_finetuned_models/birds_valid299/model.ckpt',
...
tf.app.flags.DEFINE_integer('splits', 10,
                            """Number of splits """)
tf.app.flags.DEFINE_integer('batch_size', 32, "batch size")  ## use samll batch
tf.app.flags.DEFINE_integer('gpu', 1, "The ID of GPU to use")
## ****** for error unknown flag ******
tf.app.flags.DEFINE_string('cfg', '', 'for error unknown flag')
...
def get_predictions(sess, images, pred_op):
    # splits = FLAGS.splits
    ...
    for i in range(n_batches):
        ...
        #  print('inp', inp.shape)
        pred = sess.run(pred_op, {'inputs:0': inp})  ## return numpy
        preds.append(pred)
    return preds[0]
